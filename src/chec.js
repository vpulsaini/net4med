<div className="box2 stack-top" style={{height:"300px",background:"white"}}>
                        <Accordion>
                        <Card className="my-2" style={{boxShadow:"0 0 0 3px #f1f1f1"}}>
                            <Accordion.Toggle style={{background:"white",border:"none"}} className="cen"  eventKey="0">
                            <h4 style={{color:"#150da8",fontWeight:"bold",fontSize:"40px",marginTop:"20px"}}>FAQs <i className="fa fa-caret-down"></i></h4>
                            </Accordion.Toggle>
